...
protected:
	...
	void InitializeGui()
	{
		...
		tbxPwd.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_PASSWORD | ES_LEFT | ES_WINNORMALCASE, 2.77812, 2.03729, 3.17500, 0.60854, hWnd, 1001);
