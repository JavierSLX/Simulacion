...
#define CONNECTION_STRING L"Driver={MySQL ODBC 5.3 UNICODE Driver};Server=192.168.1.121;Database=atc;Port=3300;User=fabi2601;Password=f26012013n;Option=1;"
